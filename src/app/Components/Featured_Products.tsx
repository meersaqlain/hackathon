    ...
    return (
        <div className=" bg-white justify-center items-center ">
            ...
            <h3 className="text-center text-black font-semibold text-2xl mt-10 mb-2 bg-white">Our Products</h3>
             <div className="grid grid-cols-4 items-center justify-items-center mt-10 gap-5 text-pretty bg-white">
                    ...
                    <Link href="Cart"><div className="w-[285px] h-[446px] bg-gray-200"><img src="p2.png" alt="product"/>   <ul className="font-semibold text-black ml-4 mt-4">
                        <li>Patty</li>
                        <li>Rp 2500.000</li>
                     </ul></div>
                     </Link>
                ...
                <div className="flex justify-center ">
                 ...
                 <div className="bg-[#FCF8F3] w-full h-[670px] grid grid-cols-3">
                 <div>
                   <ul className="text-black font-bold text-6xl m-10"><li>50 + Beatiful Rooms</li>
