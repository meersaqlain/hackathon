...
export default function Navbar() {
  return (
    <div>
      ...
      <header className=" grid grid-cols-6 p-10 bg-[#FFFFFF] lg:w-[1440px] md:[1440px] h-100px  text-black w-[425px]" >
        ...
        <ul className="flex justify-center items-center gap-10 text-[#000000]bg-[#FFFFFF]  col-span-2 mr-5 text-black font-bold w-[425px]">
